 ...
 * @subpackage Webdogs_Support/admin
 */
...
class Webdogs_Support_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/webdogs-support-admin.css', array(), $this->version, 'all' );
