...
$GLOBALS['webdogs_plugin_updates'] = new $webdogs_github_checker( 'https://github.com/theWEBDOGS/webdogs-support-integration/', WP_PLUGIN_DIR . '/webdogs-support-integration/webdogs-support-integration.php', 'master'); }
...
elseif( file_exists( WP_PLUGIN_DIR . '/webdogs-support-integration/webdogs-support-integration.php' ) ) { 
           $webdogs_plugin_data = get_file_data( WP_PLUGIN_DIR . '/webdogs-support-integration/webdogs-support-integration.php', array( 'Version' => 'Version' ) );
        $webdogs_latest_version = $webdogs_plugin_data['Version']; }
 else { $webdogs_latest_version = '2.0.0'; }
 return $webdogs_latest_version; } } 

if( file_exists( WP_PLUGIN_DIR . '/webdogs-support-integration/webdogs-support-integration.php' ) ) { 
    require_once WP_PLUGIN_DIR . '/webdogs-support-integration/webdogs-support-integration.php'; } /*
